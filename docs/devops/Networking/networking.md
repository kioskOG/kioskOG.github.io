...
<body>
  <main class="wrap">
    ...
    <section class="section-glass" aria-labelledby="networking-guides-title">
      <h2 id="networking-guides-title" class="section-title">
        <span aria-hidden="true">📚</span> Available Guides
      </h2>

      <div class="table-wrap">
        <table aria-describedby="networking-guides-title">
          <thead>
            <tr>
          ...
          <tbody>
            <tr>
              <td data-th="Topic">
                <a href="/docs/devops/Networking/How-NAT-Saved-the-Internet/">
                  How NAT Saved the Internet
                </a>
              </td>
              <td data-th="Description">
                How IPv4 exhaustion led to the rise of NAT and kept the Internet scalable.
              </td>
